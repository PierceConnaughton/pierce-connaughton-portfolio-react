...
export const programmingLanguages = [
    { name: 'C#', icon: 'LgCSharp' },
    { name: 'Java', icon: 'LgJava' },
...
export const frameworks = [
    { name: 'Angular', icon: 'LgAngular' },
    { name: 'React.js', icon: 'LgReact' },
    { name: 'Node.js', icon: 'LgNodejs' },
    { name: 'Express', icon: 'LgExpress' },
    { name: '.NET', icon: 'LgDotnet' },
...
export const toolsAndTechnologies = [
    { name: 'Git', icon: 'LgGit' },
    { name: 'Docker', icon: 'LgDocker' },
    { name: 'Kubernetes', icon: 'LgKubernetes' },
    { name: 'Jira', icon: 'LgJira' },
    { name: 'Freshdesk', icon: 'LgFreshdesk' },
